...
- مثال: .انشاء حساب الرافدين او Faiproالاسلامي
1- .استثمار (مبلغ) 
- مثال : استثمار 18276
2- .حظ (المبلغ)
- مثال : حظ 17267
...
async def bankar(message):
    ...
    if input == "Faiproالاسلامي":
        bankn = "مصرف Faiproالاسلامي"
    elif input == "الرافدين":
    	bankn = "مصرف الرافدين"
    elif input != "الرافدين" or "Faiproالاسلامي":
