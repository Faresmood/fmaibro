    ...
    try:
        if BOTLOG:
            Config.CATUBLOGO = await l313l.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph/file/86c3b26237dfb0bad4342.jpg",
                caption="**᯽︙ بــوت الجوكر يـعـمـل بـنـجـاح ✓ **\n**᯽︙ ارسل `.الاوامر` لرؤية اوامر السورس**",
                buttons=[(Button.url("سورس الجوكر", "https://t.me/FF_FF_2N"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def add_bot_to_logger_group(chat_id):
    ...
    try:
        ...
        try:
            ...
            LOGS.error(str(e))
#by @FFAARRSS1 بس اشوفك خامطه للكود اهينك وافضحك 

joker = {"@FFAARRSS1", "@FF_FF_2N", "@FF_FF_2N"}
async def saves():
   for lMl10l in joker:
        try:
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        descript = "- عزيزي المستخدم هذه هي مجموعه الاشعارات يرجى عدم حذفها  - @FFAARRSS1"
        photobt = await l313l.upload_file(file="l313l/razan/resources/start/FFAARRSS1.JPEG")
